...
| Repository Name | Description | Main Tools/Frameworks | Scope |
|---|---|---|---|
| [web_scraping_discounted_products](https://github.com/Jakhongir0103/web_scraping_discounted_products) | Web scraping project for finding discounted products and job listings | **Python**: BeautifulSoup, Requests, Pandas, Jupyter Notebook | Personal |
| [Transport_classification_model](https://github.com/Jakhongir0103/Transport_classification_model) | Machine learning model for transport vehicle classification | **Python**: TensorFlow/Keras, OpenCV, NumPy, Pandas, Jupyter Notebook | Personal |
| [ML_Datasets](https://github.com/Jakhongir0103/ML_Datasets) | Collection of machine learning datasets for various projects | **Data**: CSV files, ML datasets | Personal |
| [Python_course_MIT](https://github.com/Jakhongir0103/Python_course_MIT) | Assignments and projects from MIT Python programming course | **Python**: Core Python programming, algorithms | Personal |
| [Gender_classification_model](https://github.com/Jakhongir0103/Gender_classification_model) | Computer vision model for gender classification | **Python**: TensorFlow/Keras, OpenCV, Image Processing, MIT License, Jupyter Notebook | Personal |
